...
const KYC = () => {
  ...
  const fetchFileInfo = async (category, setFileInfo) => {
    ...
    try {
      ...
      const response = await axios.get(
       `${process.env.REACT_APP_API_URL}/user/document/kyc/download/${category}`,
        {
          headers: {
  ...
  const handleUpload = async (category) => {
    try {
      ...
      await axios.post(
       `${process.env.REACT_APP_API_URL}/user/upload/${category}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${authToken}`,
  ...
  const handlePreview = async (category) => {
    try {
      ...
      const response = await axios.get(
       `${process.env.REACT_APP_API_URL}/user/previewkyc/${filename}`,
        {
          headers: {
            Authorization: `Bearer ${authToken}`,
          },
  ...
  const handleDownload = async (category) => {
    try {
      ...
      const response = await axios.get(
       `${process.env.REACT_APP_API_URL}/user/document/kyc/downloadkyc/${filename}`,
        {
          headers: {
            Authorization: `Bearer ${authToken}`,
          },
  ...
  const handleConfirmRemove = (confirmed) => {
    if (confirmed) {
      ...
      axios
        .delete(
         `${process.env.REACT_APP_API_URL}/user/document/kyc/remove/${documentToRemove}`,
          {
            headers: {
              Authorization: `Bearer ${authToken}`,
            },
