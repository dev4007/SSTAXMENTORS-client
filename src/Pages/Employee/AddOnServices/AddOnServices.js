...
const AddOnServicePage = () => {
  ...
  useEffect(() => {
    const fetchAddOnServices = async () => {
      ...
      try {
        ...
        const response = await axios.get(
         `${process.env.REACT_APP_API_URL}/admin/addonservice/getalladdonservices`,
          {
            headers: {
  ...
  const handleView = async (serviceId) => {
    try {
      ...
      const response = await axios.post(
       `${process.env.REACT_APP_API_URL}/admin/addonservice/openService`,
        {
          serviceId: serviceId,
        },
        {
  ...
  const handleSolve = async () => {
    try {
      const authToken = localStorage.getItem("token");
      await axios.post(
       `${process.env.REACT_APP_API_URL}/admin/addonservice/solveService`,
        {
  ...
  const fetchServiceDetails = async (serviceId) => {
    try {
      ...
      const authToken = localStorage.getItem("token");
      const response = await axios.get(
       `${process.env.REACT_APP_API_URL}/admin/addonservice/getServiceDetails/${serviceId}`,
        {
          headers: {
            Authorization: `Bearer ${authToken}`,
          },
