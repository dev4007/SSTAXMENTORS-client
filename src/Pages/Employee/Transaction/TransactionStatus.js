...
const TransactionStatus = () => {
  ...
  const fetchPendingTransactions = async () => {
    try {
      ...
      const response = await axios.get(
        "https://www.sstaxmentors.com/transactions/transactions",{
          headers: {
  ...
  const updateTransactionStatus = async (transactionId, status) => {
    try {
      ...
      const response = await axios.post(
        `https://www.sstaxmentors.com/transactions/updatedstatus`,
  ...
  const handlePreview = async (files, transactionid) => {
    try {
      ...
      const response = await axios.get(
        `https://www.sstaxmentors.com/transactions/preview/${filename}?transactionid=${transactionid}`,
        {
          headers: {
