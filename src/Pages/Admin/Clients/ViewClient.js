...
function ViewClient() {
  ...
  const changeClientType = async (client) => {
    try {
      ...
      const response = await axios.put(
        `https://www.sstaxmentors.com/admin/client/changeclienttype/${selectedclienttype}`,
        { typeOfC: newType }
      );
      ...
      try {
        ...
        if (confirmationAction === "block") {
          response = await axios.post(
            "https://www.sstaxmentors.com/admin/client/blockclient",
          ...
          response =await axios.post(
            "https://www.sstaxmentors.com/admin/client/unblockclient",
            { email: selectedClient.email },
            {
              headers: {
                Authorization: `Bearer ${token}`,
  ...
  const handleView = async (client) => {
    try {
      const token = localStorage.getItem("token");
      const response = await axios.get(
        "https://www.sstaxmentors.com/admin/client/viewEntireClientDetails",
        {
