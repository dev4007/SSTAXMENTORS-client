  ...
  const handleAddField = async () => {
    try {
      ...
      const response = await axios.post(
        "https://sstaxmentors-dev4s-projects-8f80d394.vercel.app/admin/settings/gstreturns/addNewGSTReturnsField",
        {
  ...
  const handleRemoveField = async (id) => {
    try {
      ...
      const response = await axios.delete(
        `https://sstaxmentors-dev4s-projects-8f80d394.vercel.app/admin/settings/gstreturns/removeGSTReturnsField/${id}`
      );
  ...
  const handleToggleActive = async (id, isActive) => {
    try {
      ...
      const response = await axios.put(
        `https://sstaxmentors-dev4s-projects-8f80d394.vercel.app/admin/settings/gstreturns/toggleActiveFieldGSTR/${id}`
      );
