  ...
  const fetchNames = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/admin/settings/license/Licensesnames`
      );
  ...
  const handleAddName = async () => {
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/admin/settings/license/addnewLicensefield`,
        {
          name: newName.trim(),
  ...
  const handleRemoveName = async (id) => {
    try {
      ...
      const response = await axios.delete(
       `${process.env.REACT_APP_API_URL}/admin/settings/license/removeLicense/${id}`
      );
  ...
  const handleToggleActive = async (id, isActive) => {
    try {
      ...
      const response = await axios.put(
       `${process.env.REACT_APP_API_URL}/admin/settings/license/toggleActiveFieldLicense/${id}`
      );
