...
const AddOnServices = () => {
    ...
    const fetchAddOnServices = async () => {
      try {
        ...
        const response = await axios.get(
          "https://www.sstaxmentors.com/admin/settings/addonservice/getAddOnServices",
          {
            headers: {
  ...
  const handleAddAddOnService = async () => {
    try {
      await axios.post("https://www.sstaxmentors.com/admin/settings/addonservice/addNewAddOnService", {
  ...
  const handleRemoveAddOnService = async (addOnServiceId) => {
    try {
      await axios.delete(
        `https://www.sstaxmentors.com/admin/settings/addonservice/deleteAddOnService/${addOnServiceId}`
      );
      setErrorMessage("");
      // Refresh add-on services list
      const token = localStorage.getItem("token");
  ...
  const handleRemoveSubService = async (addOnServiceId, subServiceIndex) => {
    ...
    try {
      await axios.delete(
        `https://www.sstaxmentors.com/admin/settings/addonservice/deleteSubService/${addOnServiceId}/${subServiceIndex}`
      );
      setErrorMessage("");
      // Refresh add-on services list
      const token = localStorage.getItem("token");
  ...
  const handleSubmitSubServices = async (addOnServiceId) => {
    try {
      await axios.post(
        `https://www.sstaxmentors.com/admin/settings/addonservice/addSubServices/${addOnServiceId}`,
