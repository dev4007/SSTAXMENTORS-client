...
const GSTNoticeSettings = () => {
  ...
  const fetchFields = async () => {
    try {
      setLoading(true);
      const response = await axios.get("https://www.sstaxmentors.com/admin/settings/gstnotice/gstFields");
  ...
  const handleAddField = async () => {
    try {
      ...
      const response = await axios.post(
        "https://www.sstaxmentors.com/admin/settings/gstnotice/addNewGSTNoticeField",
        {
  ...
  const handleRemoveField = async (id) => {
    try {
      ...
      const response = await axios.delete(
        `https://www.sstaxmentors.com/admin/settings/gstnotice/removeGSTNoticeField/${id}`
      );
  ...
  const handleToggleActive = async (id, isActive) => {
    try {
      ...
      const response = await axios.put(
        `https://www.sstaxmentors.com/admin/settings/gstnotice/toggleActiveFieldGST/${id}`
      );
