  ...
  const fetchMainNames = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/admin/settings/company/CompanyDetails`,
        {
          headers: {
  ...
  const handleAddMainName = async () => {
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/admin/settings/company/addNewCompanyField`,
        {
  ...
  const handleRemoveMainName = async (id) => {
    try {
      ...
      const response = await axios.delete(
       `${process.env.REACT_APP_API_URL}/admin/settings/company/removeCompanyField/${id}`
      );
  ...
  const handleToggleActive = async (id, isActive) => {
    try {
      ...
      const response = await axios.put(
       `${process.env.REACT_APP_API_URL}/admin/settings/company/toggleActiveFieldCompany/${id}`
      );
