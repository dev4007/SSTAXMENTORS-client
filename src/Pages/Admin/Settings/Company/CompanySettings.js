  ...
  const fetchMainNames = async () => {
    try {
      ...
      const response = await axios.get(
        "https://www.sstaxmentors.com/admin/settings/company/CompanyDetails",
        {
          headers: {
  ...
  const handleAddMainName = async () => {
    try {
      ...
      const response = await axios.post(
        "https://www.sstaxmentors.com/admin/settings/company/addNewCompanyField",
        {
  ...
  const handleRemoveMainName = async (id) => {
    try {
      ...
      const response = await axios.delete(
        `https://www.sstaxmentors.com/admin/settings/company/removeCompanyField/${id}`
      );
  ...
  const handleToggleActive = async (id, isActive) => {
    try {
      ...
      const response = await axios.put(
        `https://www.sstaxmentors.com/admin/settings/company/toggleActiveFieldCompany/${id}`
      );
