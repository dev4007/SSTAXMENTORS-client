  ...
  const handleAddField = async () => {
    try {
      ...
      const response = await axios.post(
        "https://www.sstaxmentors.com/admin/settings/itreturns/addNewITReturnsField",
        {
  ...
  const handleRemoveField = async (id) => {
    try {
      ...
      const response = await axios.delete(
        `https://www.sstaxmentors.com/admin/settings/itreturns/removeITReturnsField/${id}`
      );
  ...
  const handleToggleActive = async (id, isActive) => {
    try {
      ...
      const response = await axios.put(
        `https://www.sstaxmentors.com/admin/settings/itreturns/toggleActiveFieldITR/${id}`
      );
