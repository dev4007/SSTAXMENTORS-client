  ...
  const handleAddField = async () => {
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/admin/settings/itreturns/addNewITReturnsField`,
        {
  ...
  const handleRemoveField = async (id) => {
    try {
      ...
      const response = await axios.delete(
       `${process.env.REACT_APP_API_URL}/admin/settings/itreturns/removeITReturnsField/${id}`
      );
  ...
  const handleToggleActive = async (id, isActive) => {
    try {
      ...
      const response = await axios.put(
       `${process.env.REACT_APP_API_URL}/admin/settings/itreturns/toggleActiveFieldITR/${id}`
      );
