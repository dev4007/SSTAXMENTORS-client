...
const GSTRegistration = () => {
    ...
    const fetchCompanyNames = async () => {
      try {
        ...
        const response = await axios.get(
          `${process.env.REACT_APP_API_URL}/user/getCompanyNameOnlyDetails`,
          {
            headers: {
  ...
  const fetchData = async (companyName) => {
    ...
    try {
      ...
      const url =`${process.env.REACT_APP_API_URL}/user/getgstdoc/${companyName}`;
  ...
  const handlePreview = async () => {
    try {
      const token = localStorage.getItem("token");
      const url =`${process.env.REACT_APP_API_URL}/user/previewGSTR/${file.name}`;
  ...
  const handleDownload = async () => {
    try {
      const token = localStorage.getItem("token");
      const url =`${process.env.REACT_APP_API_URL}/user/downloadGSTR/${file.name}`;
  ...
  const handleSubmit = async () => {
    try {
      ...
      const token = localStorage.getItem("token");
      const url =`${process.env.REACT_APP_API_URL}/user/gstregistration`;
